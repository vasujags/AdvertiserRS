package com.iheartmedia.advertiser.type;
...
import com.iheartmedia.advertiser.util.ValidationConstants;

public enum ErrorCodeType 
{
	VALUE_CANNOT_BE_NULL(5013, ValidationConstants.VALUE_CANNOT_BE_NULL_MESSAGE,ValueCannotBeNull.class),
	CONTACTNUMBER_INVALID(5014,ValidationConstants.CONTACT_NUMBER_INVALID,ContactNumberInvalid.class);
	
	
	
	
	public static class ValueCannotBeNull implements Payload {}
	public static class ContactNumberInvalid implements Payload {}
